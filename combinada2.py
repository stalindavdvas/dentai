...
def upload_file():
    ...
    prompt = f"Genera una recomendación médica para el paciente que tiene la enfermedad {best_disease} con una confianza de {best_confidence * 100:.1f}%. ¿Qué acción debe tomar?"
    
    # Usar DistilGPT-2 para generar la recomendación
    recommendation = generator(prompt, max_length=100, num_return_sequences=1)[0]['generated_text']
    ...
    return jsonify({
        ...
        'recommendation': recommendation.strip()  # Aquí devolvemos la recomendación generada
    })
