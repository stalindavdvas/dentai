...
# Compilar modelo con un optimizador como Adam
model.compile(
...
# Callback para guardar el mejor modelo basado en el loss de la clase
checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    os.path.join(MODEL_DIR, 'best_model.h5'),
    monitor='loss',  # Monitorea la pérdida de entrenamiento
    save_best_only=True,
...
model.save(os.path.join(MODEL_DIR, "modelo_dental_final.h5"))
print(f"Modelo guardado en: {os.path.join(MODEL_DIR, 'modelo_dental_final.h5')}")
